...
### Added
- RPM packages for Fedora, RHEL, Rocky Linux, AlmaLinux, and other DNF-based distributions

### Changed
- Release automation and Linux installation documentation now include `.rpm` artifacts

## [0.1.65] - 2026-06-04

### Added
- Added DeepSeek, OpenRouter

### Changed
- Publish landing page on alliehere.com
...
### Changed
- pull --rebase before AUR push to handle diverged remote
...
### Added
- add Ollama to README features, tech stack, and env vars

### Changed
- Internal maintenance and release prep

### Fixed
- fix project name to Alogi
